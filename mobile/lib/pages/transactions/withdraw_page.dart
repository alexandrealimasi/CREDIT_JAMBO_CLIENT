...
import 'package:mobile/pages/transactions/add_withdraw_page.dart';
...
// import '../transactions/add_withdraw_page.dart';
    ...
    return Scaffold(
      ...
      body: Consumer2<UserProvider, TransactionProvider>(
        builder: (context, userProvider, transactionProvider, child) {
          final withdrawHistory = transactionProvider.transactions
              .where((tx) => tx.type.toLowerCase() == "withdraw")
              .toList();
          return Padding(
                    ...
                    ElevatedButton.icon(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const AddWithdrawPage(),
                          ),
                        );
                      },
